...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 lg:left-0 flex flex-row lg:flex-col justify-between w-full lg:w-[7%] h-[10%] lg:h-screen bg-gray-800 text-white lg:rounded-r-2xl z-50">
      {/* Logo */}
...
//       {/* Logo */}
//       <div className="logo-div relative h-[75px] lg:h-[100px] bg-green-500 flex items-center justify-center">
//         {/* <!-- First div, positioned at the top --> */}
//         <div className="absolute top-0 left-0 right-0 flex items-center justify-center bg-custom-logo1 h-[70px] lg:h-[75px] rounded-r-2xl">
//           {/* <!-- Empty div for styling --> */}
//         </div>

//         {/* <!-- Second div, covering half of the first div --> */}
//         <div className="absolute top-[45px] left-0 right-0 h-[55px] bg-custom-logo2 rounded-tl-2xl rounded-br-2xl"></div>

//         {/* <!-- Logo button, centered over both divs --> */}
//         <button className="absolute top-[35px] flex-shrink-0 text-2xl font-bold z-10">
//           <svg xmlns="http://www.w3.org/2000/svg" width="28" height="26">
...
//       {/* <div>
//         <div className='flex items-center justify-center bg-custom-logo1 w-[20%] lg:w-full h-[35px] lg:h-[75px] rounded-r-2xl'>
//         </div>
//         <div className=' flex items-center justify-center bg-custom-logo2 w-[20%] lg:w-full h-[35px] lg:h-[75px] rounded-l-2xl'></div>
//       </div> */}

      
//       {/* <div>
//         <div className='flex items-center justify-center bg-custom-logo1 w-[20%] lg:w-full h-[70px] lg:h-[75px] rounded-r-2xl'>
//           <button className="flex-shrink-0 text-2xl font-bold">
//             <svg xmlns="http://www.w3.org/2000/svg" width="28" height="26"><path fill="#FFF" fillRule="evenodd" d="M20.513 0C24.965 2.309 28 6.91 28 12.21 28 19.826 21.732 26 14 26S0 19.826 0 12.21C0 6.91 3.035 2.309 7.487 0L14 12.9z"/></svg>
//           </button>
//         </div>
//         <div className=' flex items-center justify-center bg-custom-logo2 w-[20%] lg:w-full h-[70px] lg:h-[75px] rounded-l-2xl'></div>
//       </div> */}
